...
// initialize timer2
uint8_t bsp_tim2_events_init(void);
...
uint8_t bsp_tim2_events_register_event(uint8_t const channel_nr, event_trigger_t const trigger, event_handler_t const event_callback, uint8_t fire_and_forget, uint16_t const period);

// clear an event
uint8_t bsp_tim2_events_forget_event(uint8_t const event_nr);

// manually trigger an event
uint8_t bsp_tim2_events_trigger_event(uint8_t const event_nr);
